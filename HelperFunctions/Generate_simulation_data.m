function [ X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8,Y9,Y10,Y11 ] = Generate_simulation_data(data_length)
...
%% X1 Linear
% Sample random number matrix data_lengthx10 out of randn pool
% X is causal matrix
tic;
sigmaa = 0.1;
X1 = randi([1 1e6],data_length,10);
...
X9(:,1) = sin([1:data_length]*w(1));
X9(:,2) = sin(2*[1:data_length]*w(2));
X9(:,3) = cos([1:data_length]*w(3));
X9(:,4) = cos(2*[1:data_length]*w(4));
X9(:,5) = sin(3*[1:data_length]*w(5));
X9(:,6) = sin(4*[1:data_length]*w(6));
X9(:,7) = cos(3*[1:data_length]*w(7));
X9(:,8) = cos(4*[1:data_length]*w(8));
X9(:,9) = sin([1:data_length]*w(9))+sin(2*[1:data_length]*w(9));
X9(:,10) = cos([1:data_length]*w(10))+cos(2*[1:data_length]*w(10));
...
X10(:,1) = sin([1:data_length]*w(1));
X10(:,2) = sin(2*[1:data_length]*w(2));
X10(:,3) = cos([1:data_length]*w(3));
X10(:,4) = cos(2*[1:data_length]*w(4));
X10(:,5) = sin(3*[1:data_length]*w(5));
X10(:,6) = sin(4*[1:data_length]*w(6));
X10(:,7) = cos(3*[1:data_length]*w(7));
X10(:,8) = cos(4*[1:data_length]*w(8));
X10(:,9) = sin([1:data_length]*w(9))+sin(2*[1:data_length]*w(9));
X10(:,10) = cos([1:data_length]*w(10))+cos(2*[1:data_length]*w(10));
...
X11(:,1) = sin([1:data_length]*w(1));
X11(:,2) = sin(2*[1:data_length]*w(2));
X11(:,3) = cos([1:data_length]*w(3));
X11(:,4) = cos(2*[1:data_length]*w(4));
X11(:,5) = sin(3*[1:data_length]*w(5));
X11(:,6) = sin(4*[1:data_length]*w(6));
X11(:,7) = cos(3*[1:data_length]*w(7));
X11(:,8) = cos(4*[1:data_length]*w(8));
X11(:,9) = sin([1:data_length]*w(9))+sin(2*[1:data_length]*w(9));
X11(:,10) = cos([1:data_length]*w(10))+cos(2*[1:data_length]*w(10));
